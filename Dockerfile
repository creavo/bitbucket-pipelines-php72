...
RUN DEBIAN_FRONTEND=noninteractive apt-get update && \
    ...
    DEBIAN_FRONTEND=noninteractive apt-get install -y \
    yarn \
    php-pear php7.2-mysql php7.2-zip php7.2-xml php7.2-mbstring php7.2-curl php7.2-json php7.2-pdo php7.2-tokenizer php7.2-cli php7.2-imap php7.2-intl php7.2-gd php7.2-xdebug php7.2-soap php7.2-gmp php-imagick \
